...
// const Policy = () => {
//   return (
//     <div className="min-h-screen px-6 py-10 md:px-20 lg:px-32 transition-colors duration-300 ">
//       <div className="max-w-4xl mx-auto shadow-lg rounded-2xl p-10 dark:bg-gray-800 ">
...
//             <li>User-generated content such as comments or submissions</li>
...
//             <li>Secure password hashing (we never store plain passwords)</li>
//           </ul>
//         </section>
...
//           </h2>
//           <p className="text-gray-700 dark:text-gray-300">
//             We use cookies to enhance your experience. These cookies help us
//             remember your preferences, analyze performance, and deliver relevant
//             content. You may disable cookies in your browser settings if you
//             prefer.
//           </p>
//         </section>
...
//             communicated via in-app notifications or email. We recommend
