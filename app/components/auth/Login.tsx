...
import { signInsSchema } from "../../../utils/authValidation";
...
const Login = ({ setRoute, setIsOpen }: LoginPops) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: signInsSchema,
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="mt-5 mb-4">
        ...
        <button
          ...
          className={`${
            styles.submit
          } w-full py-3 mt-10 rounded-full cursor-pointer bg-gradient-to-r from-blue-500 via-purple-500 to-teal-400 text-white transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-501 ${
